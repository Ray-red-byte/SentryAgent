---
description: "Bundle Fast Path: Gemini Context Caching — file list only, LLM locates them in cache"
...
You are auditing the **"{bundle_name}"** security domain bundle using the cached repository context.

Locate and carefully read ALL of the following files in your cached memory:
{file_list}
